    ...
    <div class="branding d-flex align-items-center">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-end">
        <a href="" class="logo d-flex align-items-center me-auto">
          ...
          <!-- <h1 class="sitename">LAZISMU RSMB</h1>  -->
        </a>
    ...
    <section id="hero" class="hero section">
      <div style="margin-bottom: 50px;">
        ...
        <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
          ...
          Penanganan masalah sosial yang timbul akibat ekses external terhadap kehidupan mustahik, seperti bantuan
          bencana, pendampingan manula dan kegiatan karikatif.
    ...
    <section id="featured-services" class="featured-services section">
      <div class="container">
        ...
        <div class="service-item position-relative"
          ...
          <!-- Konten Teks -->
          <div>
          <h4 style="font-size: 16px; font-weight: bold;"><a href="{{ route('detail.dokumentasi', $dok->id) }}" class="stretched">{{ $dok->judul }}</a></h4>
      ...
      @endforeach
          ...
          <div class="text-center mt-4">
            <a href="{{ route('dokumentasi.create') }}"
              style="font-size: 30px; text-decoration: none; font-weight: bold; display: inline-block; background: #28a745; color: white; border-radius: 50%; width: 40px; height: 40px; line-height: 40px;">
              +
            </a>
          </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><a class="glightbox" data-serviec="images-gallery"
  ...
  <div class="swiper-slide">
    ...
    <section id="contact" class="contact section">
      ...
      <head>
        ...
        <title>Google Maps with Circular Contact Info</title>
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css">
        <style>
          .contact-section {
            display: flex;
          ...
          .info-item {
            ...
            border-radius: 50%;
            /* Membuat elemen bulat */
            width: 200px;
            /* Lebar dan tinggi untuk elemen bulat */
            height: 120px;
            display: flex;
            flex-direction: column;
          ...
          @media (max-width: 768px) {
            ...
            .info-item {
              width: 100px;
              /* Ukuran lebih kecil untuk perangkat kecil */
              height: 100px;
            }
          }
        </style>
        ...
        <div class="container my-5">
          ...
          <div class="contact-section">
            ...
            <head>
              <meta charset="UTF-8">
              <meta name="viewport" content="width=device-width, initial-scale=1.0">
              <title>Contact Info Horizontal</title>
              <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css">
              <style>
                body {
              ...
              <div class="container my-5">
                ...
                <div class="info-row">
                  ...
                  <div class="info-item" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div>
                      <h3>Alamat</h3>
                      <p>Jalan XYZ No.123, Kota Bandung</p>
                    </div>
                  </div>
