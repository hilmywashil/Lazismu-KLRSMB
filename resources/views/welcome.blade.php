    ...
    <main class="main">
        ...
        <section id="gallery" class="gallery section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Dokumentasi</h2>
                <p>Dokumentasi Program dari Lazismu KLRSMB</p>
                            ...
                            @if (!empty($detail->image))
                                <div class="swiper-slide">
                                    <a class="glightbox" data-gallery="images-gallery"
                                        href="{{ asset('storage/dokumentasi/' . $detail->image) }}">
                                        <img src="{{ asset('storage/dokumentasi/' . $detail->image) }}" class="img-fluid"
                                            alt="" style="aspect-ratio: 16 / 9; object-fit: cover;">
                                    </a>
                                </div>
                            @endif
                        @endforeach
