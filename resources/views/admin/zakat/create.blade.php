...
<body class="bg-gray-100 font-sans min-h-screen flex items-center justify-center">
    ...
    <div class="bg-white shadow-md rounded-lg p-8 w-full max-w-lg">
        <h1 class="text-2xl font-bold mb-6 text-center text-gray-800">Tambah Zakat</h1>
        ...
        <form action="{{ route('admin.zakat.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
