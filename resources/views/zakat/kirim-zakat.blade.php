        ...
        <section class="py-5">
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <form action="{{ route('zakat.kirim-zakat.store') }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $zakat->title }}" disabled>
                                <input type="hidden" name="zakat_id" value="{{ $zakat_id }}">
                            </div>
